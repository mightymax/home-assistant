...
from zigpy.zcl.clusters.general import Basic, Identify, LevelControl, OnOff, PowerConfiguration, MultistateInput
...
class RemoteH1DoubleRocker6(XiaomiCustomDevice):
    """Aqara H1 Wireless Remote Double Rocker Version WRS-R02, variant 6."""
